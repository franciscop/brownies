# Brownies [![brownies](https://img.shields.io/npm/v/brownies?label=brownies&color=greenlime)](https://www.npmjs.com/package/brownies) [![tests](https://github.com/franciscop/brownies/workflows/tests/badge.svg)](https://github.com/franciscop/brownies/actions) [![gzip size](https://img.badgesize.io/franciscop/brownies/master/index.min.js.svg?label=gzip&logo=&compression=gzip)](https://github.com/franciscop/brownies/blob/master/index.min.js) [![dependencies](https://img.shields.io/badge/dependencies-0-limegreen.svg)](https://github.com/franciscop/brownies/blob/master/package.json) [![](https://data.jsdelivr.com/v1/package/npm/brownies/badge?style=rounded)](https://www.jsdelivr.com/package/npm/brownies)
